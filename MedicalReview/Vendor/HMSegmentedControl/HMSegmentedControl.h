...
//lipeng11
enum HMSelectionIndicatorLoc {
    HMSelectionIndicatorLocBottom = 0, // indicator location
    HMSelectionIndicatorLocTop = 1 // indicator location
};
...
@property (nonatomic, assign) enum HMSelectionIndicatorLoc selectionIndicatorLoc;
