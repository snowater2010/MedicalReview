...
- (void)setDefaults {
    ...
    self.selectionIndicatorLoc = HMSelectionIndicatorLocTop;
...
- (CGRect)frameForSelectionIndicator {
    ...
    //lipeng11
    float indicatorLoc = 0.0;
    if (self.selectionIndicatorLoc == HMSelectionIndicatorLocBottom) {
         indicatorLoc = self.frame.size.height-self.selectionIndicatorHeight;
    }
    ...
    if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidth) {
        ...
        return CGRectMake(x, indicatorLoc, stringWidth, self.selectionIndicatorHeight);
    } else {
        return CGRectMake(self.segmentWidth * self.selectedIndex, indicatorLoc, self.segmentWidth, self.selectionIndicatorHeight);
    }
}
